...
String title = "Wahoo!", footer="Drip", main = "main";
float titleX, titleY, titleWidth, titleHeight;
float footerX, footerY, footerWidth, footerHeight;
float mainX, mainY, mainWidth, mainHeight;
PFont titleFont;
...
void setup()
{
  ...
  //
  //Population
  titleX = footerX = mainX = appWidth * 1/4;
  titleY = appHeight * 1/10;
  footerY = appHeight * 8/10;
  mainY = appHeight * 5/10;
  titleWidth = footerWidth = mainWidth = appWidth * 1/2;
  titleHeight = footerHeight =mainHeight = appHeight * 1/10;
  //
...
void draw()
{
  ...
  textAlign(CENTER, CENTER); //Align X&Y, see Processing.org / Reference
  //Values: [ LEFT | CENTER | RIGHT ] & [ TOP | CENTER | BOTTOM | BASELINE ]
  text( main, mainX, mainY, mainWidth, mainHeight );
